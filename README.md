...
| **Activations**, layer sequential | **8 256 B (8.1 KiB)** | peak of (input + output + that layer's own buffer), at `context.1.depthwise` |
| **Total, fully streaming** | **18 609 B (18.2 KiB)** | |
| **Total, layer sequential** | 20 042 B (19.6 KiB) | |
